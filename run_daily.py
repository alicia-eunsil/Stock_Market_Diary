...
from src.knee_shoulder.export_data import ExportApiAuth, clamp_export_month_range, fetch_export_trend_history, latest_published_export_month
...
def main() -> None:
    ...
    if data_go_service_key:
        try:
            ...
            latest_month = latest_published_export_month()
